...
extern  enum clnt_stat rpc_register_function_1(ptr , ptr , char *, char *, int , int , ptr_result *, CLIENT *);
extern  bool_t rpc_register_function_1_svc(ptr , ptr , char *, char *, int , int , ptr_result *, struct svc_req *);
